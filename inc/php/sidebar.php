    ...
    <div class="inner-sidebar">
        <div id="side-sortables" class="meta-box-sortabless ui-sortable">
            ...
            <div class="postbox about">
                ...
                <div class="inside">
                    <p><?php _e( 'This plugin allows you to easily and safely insert your custom JavaScript code in your website directly out of your WordPress Admin Area, without the need to have an external editor.', $text ); ?></p>
                </div>
            </div>
