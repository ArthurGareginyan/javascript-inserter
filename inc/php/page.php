            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'On the "Main" tab, place your custom JavaScript code in the code editor field and click the "Save changes" button.', $text ); ?>
                            <?php _e( 'Enjoy the result of applying your custom JavaScript code.', $text ); ?>
                            <?php _e( 'It\'s that simple!', $text ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'How much of JavaScript code (characters) I can enter in the code editor?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                        ...
                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'Can I add my custom JavaScript code to a specific page of my website?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'For now, this plugin does not have an option to apply the custom JavaScript code only on specific pages.', $text ); ?>
                            <?php _e( 'We plan to add this feature soon.', $text ); ?>
                            <?php _e( 'But for now in order to apply your custom JavaScript code only on specific pages of your website, you need to wrap your custom JavaScript code in a PHP code that will determine the page you want.', $text ); ?>
...
add_action( 'wp_head', 'my_custom_js_code' );</code></pre>
                        ...
                        <div class="question-<?php echo $i; ?> question-red">
                            <?php _e( 'My custom JavaScript code is not working.', $text ); ?>
                            <?php _e( 'What could be wrong?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'It happens that your custom JavaScript code that you insert on the plugin page does not work, even if an error message does not appear.', $text ); ?>
                            <?php _e( 'Here are a few of the most likely causes of the issue:', $text ); ?>
                            <ol class="custom-list">
                                <li><?php _e( 'You have a typo during the insertion of your custom JavaScript code.', $text ); ?></li>
                                <li><?php _e( 'Your custom JavaScript code has a syntax error.', $text ); ?></li>
                                <li><?php _e( 'Your custom JavaScript code is incorrect and may not work.', $text ); ?></li>
                            </ol>
                        </div>
