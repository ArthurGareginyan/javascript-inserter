            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="question-7"><?php _e( 'Can I add my custom JavaScript code to a specific page of my website?', $text ); ?></div>
                        <div class="answer-7"><?php _e( 'For now, this plugin does not have an option to apply the custom JavaScript code only on specific pages. We plan to add this feature soon. But for now in order to apply your custom JavaScript code only on specific pages of your website, you need to wrap your custom JavaScript code in a PHP code that will determine the page you want. You need something like this:', $text ); ?><br><br>
...
add_action( 'wp_head', 'my_custom_js_code' );</code></pre>
                        ...
                        <div class="question-8 question-red"><?php _e( 'My custom JavaScript code is not working. What could be wrong?', $text ); ?></div>
                        <div class="answer-8"><?php _e( 'It happens that your custom JavaScript code that you insert on the plugin page does not work, even if an error message does not appear. Here are a few of the most likely causes of the issue:', $text ); ?>
                                               <ol class="custom-counter">
