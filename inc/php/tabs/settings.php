            ...
            <div class="meta-box-sortabless">
                ...
                <form action="options.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="postbox" id="head">
                        ...
                        <div class="inside">
                            <p class="note"><?php _e( 'You can use the fields below to add your custom JavaScript code to the HEAD section of your website\'s front end.', $text ); ?></p>
                    ...
                    <div class="postbox" id="footer">
                        ...
                        <div class="inside">
                            <p class="note"><?php _e( 'You can use the fields below to add your custom JavaScript code to the FOOTER section of your website\'s front end.', $text ); ?></p>
